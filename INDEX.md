...
| ドキュメント | 内容 | 参照タイミング | 対象 |
|--------------|------|----------------|------|
| [SSOT_GUIDE.md](./SSOT_GUIDE.md) | 定数管理・SSOT実践 | 定数・設定値を追加するとき | 全言語 |
| [MODULE_GUIDE.md](./MODULE_GUIDE.md) | モジュール化・依存注入 | 新機能を追加するとき | 全言語 |
| [COMMENT_GUIDE.md](./COMMENT_GUIDE.md) | コメント・ドキュメント規約 | コードを書くとき（常時） | 全言語 |
...
- ✅ 定数は専用ファイルに集約（JS: `constants/`、Python: `config.py`）
- ✅ 新規関数にはJSDoc / docstring
- ✅ 依存注入パターンの維持
- ✅ 変更前に参照元を確認
- ✅ 型情報の付与（JS: JSDoc `@typedef`、Python: type hints）
